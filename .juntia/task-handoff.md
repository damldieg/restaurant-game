<!-- juntia:generated -->
<!-- juntia:task-meta {"text":"Actualizar docs/MILESTONES.md y .juntia/PROJECT_STATE.md para reestructurar el roadmap desde M07 en adelante con criterio gameplay-first (documentation-only, sin tocar código)","generatedAt":"2026-08-22T16:42:13.885Z"} -->
# Task Handoff
...
> Actualizar docs/MILESTONES.md y .juntia/PROJECT_STATE.md para reestructurar el roadmap desde M07 en adelante con criterio gameplay-first (documentation-only, sin tocar código)
...
Suggested roles: Engineer, Architect
Suggested skills: implementation, testing-strategy, governance-review
...
```json
{
  "task": {
    ...
    "reason": "refactor <- structure-only / code-shape language"
  },
  "workflow": {
    "name": "refactor",
  ...
  "contextSources": [
    ".juntia/context.md",
    ".juntia/governance/workflows/refactor.md"
  ],
  "taskStatus": "ACTIVE"
}
```
...
- `.juntia/governance/workflows/refactor.md` — the full process this workflow recommends.
